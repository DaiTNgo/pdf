...
os.environ['OPENAI_API_KEY'] = "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"
...
async def on_message(message: Message):
    ...
    if isCompare:
        time.sleep(20)
        await langchain(message.content, msg_chain)
...
isCompare = False
@app.post("/config")
async def config(compare: bool = Query(False)):
    global isCompare
    isCompare = compare
    return JSONResponse({
        "status": 200,
